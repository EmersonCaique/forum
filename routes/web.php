...
Route::get('profile/{user}/notification', 'UserNotificationController@index');
Route::delete('profile/{user}/notification/{notification}', 'UserNotificationController@destroy');
