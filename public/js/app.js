...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    toggle: function toggle() {
      ...
      if (this.isFavorited) {
        axios["delete"]("/reply/".concat(this.reply.id, "/favorites")).then(function (res) {
          _this.isFavorited = false;
          _this.favoritesCount--;
        });
      } else {
        axios.post("/reply/".concat(this.reply.id, "/favorites")).then(function (res) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    flash: function flash(message) {
      this.$toasted.show("Success! ".concat(this.message), {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      items: this.data,
      url: "".concat(location.pathname, "/replies")
    };
  },
  methods: {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    getId: function getId() {
      return "reply-".concat(this.reply.id);
    }
  },
  methods: {
    update: function update() {
      ...
      axios.put("/reply/".concat(this.data.id), {
        body: this.body
      }).then(function (res) {
        _this.editing = false;
    ...
    destroy: function destroy() {
      ...
      axios["delete"]("/reply/".concat(this.data.id)).then(function (res) {
        // document
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      repliesCount: this.initialRepiesCount
    };
  }
});
...
var render = function() {
  ...
  return _c("div", [
    _c(
      "button",
      {
        staticClass: "py-1 px-2    rounded text-xs flex",
        class: _vm.classes,
        attrs: { type: "submit" },
        on: { click: _vm.toggle }
      },
      [_c("span", [_vm._v(_vm._s(this.favoritesCount))])]
    )
  ])
}
var staticRenderFns = []
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "w-full p-5 bg-white mb-2 border rounded text-right" },
    [
      _c("textarea", {
        directives: [
          {
        ...
        staticClass: "w-full focus:border-none border rounded px-3 py-3",
        attrs: {
          type: "text",
          name: "body",
      ...
      _c(
        ...
        {
          staticClass:
            "px-12 py-2 bg-blue-500 rounded shadow text-white text-right mt-4",
          on: {
...
var render = function() {
  ...
  return _c(
    "div",
    {
      staticClass: "w-full p-5 bg-white mb-2 rounded border",
      attrs: { id: _vm.getId }
    },
    [
      _c(
        "div",
        { staticClass: "mb-2 border-b pb-2 flex justify-between items-center" },
        [
          _c("span", [
            _vm._v(
      ...
      !_vm.editing
        ...
        : _c("div", { staticClass: "text-right" }, [
            _c("textarea", {
              ...
              staticClass: "w-full border rounded p-4",
              domProps: { value: _vm.body },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
            ...
            _c(
              ...
              {
                staticClass:
                  "p-1 text-xs border border-blue-400 text-blue-400 rounded mt-4",
                on: {
                  click: function($event) {
                    _vm.editing = false
                  }
            ...
            _c(
              ...
              {
                staticClass:
                  "p-1 text-xs bg-blue-400 text-white rounded mt-4 mr-2",
                on: { click: _vm.update }
              },
              [_vm._v("Update")]
            )
      ...
      _c("div", { staticClass: "flex" }, [
        _c(
          "button",
          {
            staticClass: "p-1 text-xs bg-blue-400 text-white rounded mt-4 mr-2",
            on: {
              click: function($event) {
                _vm.editing = true
              }
        ...
        _c(
          "button",
          {
            staticClass: "p-1 text-xs bg-red-400 text-white rounded mt-4",
...
Vue.use(__webpack_require__(/*! vue-toasted */ "./node_modules/vue-toasted/dist/vue-toasted.min.js"));
...
__webpack_require__(/*! C:\Users\caiqu\Documents\Projetos\forum\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\caiqu\Documents\Projetos\forum\resources\sass\app.scss */"./resources/sass/app.scss");
